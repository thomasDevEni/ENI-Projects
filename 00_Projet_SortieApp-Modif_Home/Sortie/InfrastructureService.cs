...
namespace SortieApp.Infrastructure
{
    public static class InfrastructureService
    {
            ...
            services.AddDbContext<ParticipantContext>(options => options.UseSqlServer("Data Source=48SE46-HL5HHZ3;Initial Catalog=Sortie;User ID=sa;Password=Pa$$w0rd;Trust Server Certificate=True"));
